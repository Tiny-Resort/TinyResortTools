...
namespace TinyResort {
    ...
    public class TRChat {
        ...
        internal static List<TRChatCommand> predictedTriggers = new List<TRChatCommand>();
        internal static List<string> predictedCommands = new List<string>();
        ...
        internal static List<TRChatCommand> GetMatchingCommands(string trigger, string command = "") {
            ...
            Dictionary<string,TRChatCommand> collectTriggers = new Dictionary<string, TRChatCommand>();
            ...
            if (collectTriggers.Count > 0) {
                ...
                foreach (var item in list) {
                    predictedTriggers.Add(collectTriggers[item]);
                }
            }
