...
public class TRItems {
    ...
    internal static readonly Dictionary<string, TRCustomItem> customItems = new();
    internal static readonly Dictionary<int, TRCustomItem> customItemsByItemID = new();
    internal static readonly Dictionary<int, TRCustomItem> customTileObjectByID = new();
    internal static readonly Dictionary<int, TRCustomItem> customTileTypeByID = new();
    internal static readonly Dictionary<int, TRCustomItem> customVehicleByID = new();
    internal static readonly Dictionary<int, TRCustomItem> customCarryableByID = new();
    ...
    internal static string GivePlayerItem(string[] args) {
        ...
        for (var i = 0; i < Inventory.inv.invSlots.Length; i++)
            if (Inventory.inv.invSlots[i].slotUnlocked) {
                ...
                if (Inventory.inv.invSlots[i].itemNo == -1) {
                    emptyInvSlot = i;
                    break;
                }
