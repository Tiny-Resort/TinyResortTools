    ...
    internal class ItemStatusData : ItemSaveData {
        ...
        public TRCustomItem Load() {
            ...
            if (houseDetails != null) {
                ...
                WorldManager.Instance.onTileMap[objectXPos, objectYPos] = mannequinID;
                WorldManager.Instance.refreshTileObjectsOnChunksInUse(objectXPos, objectYPos);
                NetworkNavMesh.nav.updateChunkInUse();

                //WorldManager.Instance.allObjects[WorldManager.Instance.onTileMap[objectXPos, objectYPos]].showObjectOnStatusChange.showGameObject(customItem.invItem.getItemId());
            }
