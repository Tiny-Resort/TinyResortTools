...
namespace TinyResort {
    ...
    internal class ItemStatusData : ItemSaveData {
        ...
        public static void Save(int itemID, int mannequinID, int objectXPos, int objectYPos, int houseXPos, int houseYPos) {
            all.Add(new ItemStatusData { customItemID = TRItems.customItemsByItemID[itemID].customItemID, mannequinID = mannequinID, objectXPos = objectXPos, objectYPos = objectYPos, houseXPos = houseXPos, houseYPos = houseYPos});
