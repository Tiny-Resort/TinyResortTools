...
namespace TinyResort
{
    ...
    internal class HouseData : ItemSaveData {
        ...
        public static List<HouseData> all = new();
        public static List<HouseData> lostAndFound = new();
        public bool isWall;
        ...
        public TRCustomItem Load() {
            ...
            if (isWall)
                house.wall = customItem.inventoryItem.getItemId();
            else
                house.floor = customItem.inventoryItem.getItemId();
