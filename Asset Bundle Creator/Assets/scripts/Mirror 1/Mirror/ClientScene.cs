...
namespace Mirror
{
	...
	public static class ClientScene
	{
		...
		public static NetworkIdentity localPlayer
		{
			...
			set
			{
				NetworkClient.localPlayer = value;
			}
		}
		...
		public static NetworkConnection readyConnection
		{
			get
			{
				return NetworkClient.readyConnection;
			}
			set
			{
				NetworkClient.connection = value;
			}
		}

		[Obsolete("ClientScene.prefabs was moved to NetworkClient.prefabs")]
		public static Dictionary<Guid, GameObject> prefabs
		{
			get
			{
				return NetworkClient.prefabs;
			}
		}
		...
		{
			return NetworkClient.AddPlayer(readyConn);
		}

		[Obsolete("ClientScene.Ready was moved to NetworkClient.Ready")]
		public static bool Ready(NetworkConnection conn)
		{
			return NetworkClient.Ready(conn);
		}
		...
		{
			NetworkClient.RegisterPrefab(prefab, newAssetId);
		}
