...
namespace UnityStandardAssets.ImageEffects
{
	...
	internal class GlobalFogExtended : PostEffectsBase
	{
		[Serializable]
		...
		public Shader fogShaderExtended;
		...
		private void OnRenderImage(RenderTexture source, RenderTexture destination)
		{
			...
			Matrix4x4 cameraToWorldMatrix = component.cameraToWorldMatrix;
			fogMaterial.SetMatrix("_InverseViewMatrix", cameraToWorldMatrix);
			...
			Vector3 forward = Advanced.sun.transform.forward;
			fogMaterial.SetVector("SunDir", forward);
