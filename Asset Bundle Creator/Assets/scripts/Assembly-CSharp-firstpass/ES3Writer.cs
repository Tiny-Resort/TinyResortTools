...
public abstract class ES3Writer : IDisposable
{
	...
	public virtual void Write(object value, ES3Type type, ES3.ReferenceMode memberReferenceMode = ES3.ReferenceMode.ByRef)
	{
		...
		if (type == null || type.type == typeof(object))
		{
			...
			if (type == null)
			{
				throw new NotSupportedException("Types of " + (((object)type2 != null) ? type2.ToString() : null) + " are not supported. Please see the Supported Types guide for more information: https://docs.moodkie.com/easy-save-3/es3-supported-types/");
			}
		...
		if (type.isUnsupported)
		{
			if (type.isCollection || type.isDictionary)
			{
				...
				throw new NotSupportedException((((object)type3 != null) ? type3.ToString() : null) + " is not supported because it's element type is not supported. Please see the Supported Types guide for more information: https://docs.moodkie.com/easy-save-3/es3-supported-types/");
			}
			Type type4 = type.type;
			throw new NotSupportedException("Types of " + (((object)type4 != null) ? type4.ToString() : null) + " are not supported. Please see the Supported Types guide for more information: https://docs.moodkie.com/easy-save-3/es3-supported-types/");
		}
	...
	public void WritePrivateProperty(string name, object objectContainingProperty)
	{
		...
		if (eS3ReflectedProperty.IsNull)
		{
			...
			throw new MissingMemberException("A private property named " + name + " does not exist in the type " + (((object)type != null) ? type.ToString() : null));
		}
	...
	public void WritePrivateField(string name, object objectContainingField)
	{
		...
		if (eS3ReflectedMember.IsNull)
		{
			...
			throw new MissingMemberException("A private field named " + name + " does not exist in the type " + (((object)type != null) ? type.ToString() : null));
		}
	...
	public void WritePrivateProperty(string name, object objectContainingProperty, ES3Type type)
	{
		...
		if (eS3ReflectedProperty.IsNull)
		{
			...
			throw new MissingMemberException("A private property named " + name + " does not exist in the type " + (((object)type2 != null) ? type2.ToString() : null));
		}
	...
	public void WritePrivateField(string name, object objectContainingField, ES3Type type)
	{
		...
		if (eS3ReflectedMember.IsNull)
		{
			...
			throw new MissingMemberException("A private field named " + name + " does not exist in the type " + (((object)type2 != null) ? type2.ToString() : null));
		}
