	...
	public abstract class ES3ScriptableObjectType : ES3UnityObjectType
	{
		...
		protected override void WriteUnityObject(object obj, ES3Writer writer)
		{
			...
			if (obj != null && scriptableObject == null)
			{
				...
				throw new ArgumentException("Only types of UnityEngine.ScriptableObject can be written with this method, but argument given is type of " + (((object)obj2 != null) ? obj2.ToString() : null));
			}
