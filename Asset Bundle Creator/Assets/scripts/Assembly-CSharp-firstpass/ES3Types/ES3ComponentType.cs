...
namespace ES3Types
{
	...
	public abstract class ES3ComponentType : ES3UnityObjectType
	{
		...
		protected override void WriteUnityObject(object obj, ES3Writer writer)
		{
			...
			{
				Type obj2 = obj.GetType();
				throw new ArgumentException("Only types of UnityEngine.Component can be written with this method, but argument given is type of " + (((object)obj2 != null) ? obj2.ToString() : null));
			}
