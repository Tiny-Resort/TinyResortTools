...
namespace UnityEngine.Rendering.PostProcessing
{
	...
	public sealed class PostProcessLayer : MonoBehaviour
	{
		...
		private sealed class _003C_003Ec__DisplayClass54_0
		{
			...
			{
				if (kvp.Value.attribute.eventType == evt)
				{
					return !kvp.Value.attribute.builtinEffect;
				}
				return false;
			}
			...
			{
				_003C_003Ec__DisplayClass54_1 @object = new _003C_003Ec__DisplayClass54_1
				{
					searchStr = x.assemblyQualifiedName
				};
				return !effects.Exists(@object._003CUpdateBundleSortList_003Eb__3);
			}
		}
		...
		private sealed class _003C_003Ec__DisplayClass54_1
		{
			...
			{
				return b.settings.GetType().AssemblyQualifiedName == searchStr;
			}
		}

		[CompilerGenerated]
		private sealed class _003C_003Ec__DisplayClass54_2
		{
			public string typeName;

			internal bool _003CUpdateBundleSortList_003Eb__4(SerializedBundleRef b)
			{
				return b.assemblyQualifiedName == typeName;
			}
		}

		[CompilerGenerated]
		private sealed class _003C_003Ec__DisplayClass54_3
		{
			public string typeName;

			internal bool _003CUpdateBundleSortList_003Eb__5(PostProcessBundle b)
			{
				return b.settings.GetType().AssemblyQualifiedName == typeName;
			}
		}
		...
		private sealed class _003C_003Ec
		{
			...
			public static Func<KeyValuePair<Type, PostProcessBundle>, PostProcessBundle> _003C_003E9__54_1;

			internal PostProcessBundle _003CUpdateBundleSortList_003Eb__54_1(KeyValuePair<Type, PostProcessBundle> kvp)
			{
				return kvp.Value;
			}
		}
		...
		private bool DynamicResolutionAllowsFinalBlitToCameraTarget()
		{
			...
			{
				if ((double)ScalableBufferManager.heightScaleFactor == 1.0)
				{
					return (double)ScalableBufferManager.widthScaleFactor == 1.0;
				}
				return false;
			}
			return true;
		...
		private void UpdateBundleSortList(List<SerializedBundleRef> sortedList, PostProcessEvent evt)
		{
			...
			_003C_003Ec__DisplayClass54_.evt = evt;
			_003C_003Ec__DisplayClass54_.effects = m_Bundles.Where(_003C_003Ec__DisplayClass54_._003CUpdateBundleSortList_003Eb__0).Select(_003C_003Ec._003C_003E9__54_1 ?? (_003C_003Ec._003C_003E9__54_1 = _003C_003Ec._003C_003E9._003CUpdateBundleSortList_003Eb__54_1)).ToList();
			sortedList.RemoveAll(_003C_003Ec__DisplayClass54_._003CUpdateBundleSortList_003Eb__2);
			foreach (PostProcessBundle effect in _003C_003Ec__DisplayClass54_.effects)
			{
				_003C_003Ec__DisplayClass54_2 _003C_003Ec__DisplayClass54_2 = new _003C_003Ec__DisplayClass54_2();
				_003C_003Ec__DisplayClass54_2.typeName = effect.settings.GetType().AssemblyQualifiedName;
				if (!sortedList.Exists(_003C_003Ec__DisplayClass54_2._003CUpdateBundleSortList_003Eb__4))
				{
					SerializedBundleRef item = new SerializedBundleRef
					{
						assemblyQualifiedName = _003C_003Ec__DisplayClass54_2.typeName
					};
					sortedList.Add(item);
				}
			}
			...
			{
				_003C_003Ec__DisplayClass54_3 _003C_003Ec__DisplayClass54_3 = new _003C_003Ec__DisplayClass54_3();
				_003C_003Ec__DisplayClass54_3.typeName = sorted.assemblyQualifiedName;
				PostProcessBundle bundle = _003C_003Ec__DisplayClass54_.effects.Find(_003C_003Ec__DisplayClass54_3._003CUpdateBundleSortList_003Eb__5);
		...
		private void BuildCommandBuffers()
		{
			...
			RenderTextureFormat renderTextureFormat = (m_Camera.allowHDR ? RuntimeUtilities.defaultHDRRenderTextureFormat : RenderTextureFormat.Default);
			...
			if (num > 0)
			{
				...
				{
					commandBuffer.BuiltinBlit(currentContext.source, currentContext.destination, RuntimeUtilities.copyStdMaterial, stopNaNPropagation ? 1 : 0);
			...
			int num2 = -1;
			bool flag8 = !m_NaNKilled && stopNaNPropagation && RuntimeUtilities.isFloatingPointFormat(renderTextureFormat);
			if (RequiresInitialBlit(m_Camera, currentContext) || flag8)
			{
				num2 = m_TargetPool.Get();
				currentContext.GetScreenSpaceTemporaryRT(m_LegacyCmdBuffer, num2, 0, renderTextureFormat, RenderTextureReadWrite.sRGB);
				m_LegacyCmdBuffer.BuiltinBlit(renderTargetIdentifier, num2, RuntimeUtilities.copyStdMaterial, stopNaNPropagation ? 1 : 0);
				if (!m_NaNKilled)
				{
			...
			if (finalBlitToCameraTarget && !RuntimeUtilities.scriptableRenderPipelineActive && DynamicResolutionAllowsFinalBlitToCameraTarget())
			{
				...
				{
					currentContext.destination = m_Camera.targetTexture.colorBuffer;
				}
				else
				{
			...
			if (num2 > -1)
			{
				m_LegacyCmdBuffer.ReleaseTemporaryRT(num2);
			}
		}
		...
		private void SetLegacyCameraFlags(PostProcessRenderContext context)
		{
			...
			cameraDepthFlags = depthTextureMode;
		}
			...
			for (int i = 0; i < context.numberOfEyes; i++)
			{
				...
				if (!flag && context.numberOfEyes > 1)
				{
					...
					if (context.stereoActive)
					{
						...
						{
							command.BlitFullscreenTriangleFromDoubleWide(context.source, num, RuntimeUtilities.copyStdFromDoubleWideMaterial, stopNaNPropagation ? 1 : 0, i);
							flag = true;
						}
					}
					context.source = num;
		...
		private int RenderBuiltins(PostProcessRenderContext context, bool isFinalPass, int releaseTargetAfterUse = -1, int eye = -1)
		{
			...
			int num2 = RenderEffect<DepthOfField>(context, true);
