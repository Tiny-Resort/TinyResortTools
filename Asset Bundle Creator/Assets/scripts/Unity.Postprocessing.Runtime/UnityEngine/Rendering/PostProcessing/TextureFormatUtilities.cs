	...
	public static class TextureFormatUtilities
	{
		...
		public static RenderTextureFormat GetUncompressedRenderTextureFormat(Texture texture)
		{
			...
			if (texture is Texture2D)
			{
				...
				RenderTextureFormat value;
				if (!s_FormatAliasMap.TryGetValue((int)format, out value))
				{
		...
		{
			bool value;
			s_SupportedRenderTextureFormats.TryGetValue((int)format, out value);
			return value;
		}
		...
		{
			bool value;
			s_SupportedTextureFormats.TryGetValue((int)format, out value);
			return value;
		}
	}
}
