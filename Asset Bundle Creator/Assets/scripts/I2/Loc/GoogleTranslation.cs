...
namespace I2.Loc
{
	public static class GoogleTranslation
	{
		...
		private sealed class _003C_003Ec__DisplayClass2_0
		{
			...
			internal void _003CTranslate_003Eb__0(Dictionary<string, TranslationQuery> results, string error)
			{
		...
		public static void Translate(string text, string LanguageCodeFrom, string LanguageCodeTo, fnOnTranslated OnTranslationReady)
		{
			...
			_003C_003Ec__DisplayClass2_.OnTranslationReady = OnTranslationReady;
			_003C_003Ec__DisplayClass2_.text = text;
			_003C_003Ec__DisplayClass2_.LanguageCodeTo = LanguageCodeTo;
			LocalizationManager.InitializeIfNeeded();
			if (!CanTranslate())
			{
				_003C_003Ec__DisplayClass2_.OnTranslationReady(null, "WebService is not set correctly or needs to be reinstalled");
				return;
			}
			if (_003C_003Ec__DisplayClass2_.LanguageCodeTo == LanguageCodeFrom)
			{
				_003C_003Ec__DisplayClass2_.OnTranslationReady(_003C_003Ec__DisplayClass2_.text, null);
				return;
			}
			_003C_003Ec__DisplayClass2_.queries = new Dictionary<string, TranslationQuery>();
			if (string.IsNullOrEmpty(_003C_003Ec__DisplayClass2_.LanguageCodeTo))
			{
				_003C_003Ec__DisplayClass2_.OnTranslationReady(string.Empty, null);
				return;
			}
			CreateQueries(_003C_003Ec__DisplayClass2_.text, LanguageCodeFrom, _003C_003Ec__DisplayClass2_.LanguageCodeTo, _003C_003Ec__DisplayClass2_.queries);
			Translate(_003C_003Ec__DisplayClass2_.queries, _003C_003Ec__DisplayClass2_._003CTranslate_003Eb__0);
		}
